...
namespace UDE_MachineVision
{
    public class emguROI_Gray
    {
        ...
        /// 原始資料
        /// </summary>
        public Image<Gray, Byte> eROI_data = null; // ROI_原始資料
        /// <summary>
        /// 左上X座標
        /// </summary>
        ...
        private Image<Gray, Byte> eROI_parent = null; // ROI_對應的父Image
        ...
        public void SetPlacement(int x, int y, int w, int h) // 設定ROI位置
        {
            ...
            eROI_data = new Image<Gray, Byte>(eROI_parent.Bitmap);
            eROI_data.ROI = eROI;
        }
        /// <summary>
        /// 將ROI依附在Image上
        ...
        public void Attach(ref Image<Gray, Byte> srcImage)
        {
        ...
        {
            eROI_data = new Image<Gray, Byte>(path);
        }
        /// <summary>
        /// 存檔圖片至指定路徑
        /// </summary>
